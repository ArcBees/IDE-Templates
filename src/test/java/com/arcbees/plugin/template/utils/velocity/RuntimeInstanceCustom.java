 ...
 */
public class RuntimeInstanceCustom implements RuntimeConstants, RuntimeServices
{
    /**
        ...
        throws Exception
    {
        if (!initialized && !initializing)
        {
            ...
            log.trace("*******************************************************************");
            log.debug("Starting Apache Velocity v1.5 (compiled: 2013-07-20 13:58:46)");
